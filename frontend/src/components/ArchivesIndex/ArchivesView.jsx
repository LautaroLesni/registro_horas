...
import { fetchArchivedNotes } from "../../redux/slices/notes";
import NotesToolBar from "../NotesIndex/NotesToolBar";
const ArchivesView = () => {
  ...
  useEffect(() => {
    dispatch(fetchArchivedNotes(currentUser.id));
  }, [dispatch]);
